...
| `TRACE_STATS_TIMING` | unset | set 시 stats 단계별 elapsed 출력 |
| `TRACE_CHART_TIMING` | unset | set 시 chart 단계별 elapsed 출력 |
| `TRACE_RAW_TIMING` | unset | set 시 ReadParquet (DuckDB) 단계별 elapsed 출력 (`output/raw_rpc_duckdb.rs:49`) |

...
set_location='T3-0', pre_command_id=3, tc_pre_command_ids='3,0,5'
...
```sql
-- portal_slot_pre_commands
set_location='T3-0', pre_command_id=3, tc_pre_command_ids='3,0,5,0,0'
--                                                        ↑   ↑   ↑   ↑   ↑
--                                                       #1  #2  #3  #4  #5
--                                                   tiotest  -  fio  -   -
...
-- SlotInfomation (set_location='T3-0') — 외부 DB
...
Slot 1: (행 생성) set_location='T3-1', pre_command_id=5
```
...
→ POST /api/pre-commands/tc/sync { setLocation: "T3-0", tcPreCommandIds: "5,3,0" }
```

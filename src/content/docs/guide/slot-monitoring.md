...
| **idle** | 회색 | 유휴 상태 |
| **ready** | 파랑 | 테스트 준비 완료 |
| **running** | 노랑/주황 | 테스트 실행 중 |
| **pass** | 초록 | 테스트 통과 |
| **fail** | 빨강 | 테스트 실패 |

슬롯 카드에는 슬롯 번호, 현재 상태, 할당된 TR/TC 정보가 표시됩니다.
...
슬롯을 하나 이상 선택하면 화면 하단에 **Selection Sheet** 액션 패널이 나타납니다. Context Menu와 동일한 작업을 버튼으로 제공하며, 다중 선택된 슬롯에 일괄 작업을 수행할 수 있습니다.
